                        ...
                        for log in safety_logs:
                            ...
                            with st.expander(f"{action_color} {event_type_icon} {log.get('event_type', 'Unknown')} - {status_text} - {log.get('timestamp', 'N/A')[:19]}"):
                                ...
                                with col2:
                                    ...
                                    if content_safety_result and content_safety_result.get('content_safety_result'):
                                        st.write("**Content Safety Issues:**")
                                        for category, details in content_safety_result['content_safety_result'].items():
                                            if details.get('severity', 0) > 0:
                                    ...
                                    if log.get('pii_detected'):
                                        ...
                                        if pii_entities:
                                            entity_types = [entity.get('category', 'Unknown') for entity in pii_entities]
