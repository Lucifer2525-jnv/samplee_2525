        ...
        def render_admin_panel():
            ...
            with admin_tab1:
                ...
                if success:
                    ...
                    if safety_metrics:
                        st.subheader("Content Safety Overview")
                        col1, col2, col3, col4 = st.columns(4)
                        
                        with col1:
                            st.metric("Total Safety Checks", safety_metrics.get("total_safety_checks", 0))
                        with col2:
                            st.metric("Blocked Content", safety_metrics.get("blocked_content", 0))
                        with col3:
